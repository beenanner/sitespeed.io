...
nav: start
image: {{site.url}}/img/sitespeed-2.0-twitter.png
---
<img src="{{site.url}}/img/sitespeed.io-logo-large2.png" class="pull-left img-big" alt="Sitespeed.io logo" width="188" height="200" onLoad="window.performance.mark('logoTime');">
...
You can clone or fork the project at [![Github]({{site.url}}/img/GitHub-Mark-64px.png){: .middle}](https://github.com/sitespeedio/sitespeed.io/issues) and if you like sitespeed.io, please give us a [![Give us a star]({{site.url}}/img/star3.png){: .middle}](https://github.com/sitespeedio/sitespeed.io/stargazers)!
